...
public class Main16 {
    ...
    public static void main(String[] args) {
        Main16 minSumASumB = new Main16();
        Scanner cin = new Scanner(System.in);
        int caseNum = Integer.parseInt(cin.nextLine().trim());
        for (int i = 0; i < caseNum; i++) {
            minSumASumB.swapToMinusDiff(minSumASumB.StringarrToIntarr(cin.nextLine()), minSumASumB.StringarrToIntarr(cin.nextLine()));
        }
    }
    ...
    public void swapToMinusDiff(int[] a, int[] b) {
        ...
        System.out.println(Math.abs(oldDiff));
    }
